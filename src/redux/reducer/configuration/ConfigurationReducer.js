...
import { Configuration } from '../../../api/BackEndURL'
...
export const configurationGet = createAsyncThunk("ConfigurationGet", async () => {
    return await Configuration.method.get(Configuration.URL.get).then((response) => response.data)
})

export const configurationPost = createAsyncThunk("ConfigurationAdd", async (Data) => {
    return await Configuration.method.post(`${Configuration.URL.post}`, Data).then((response) => response.data)
})

export const configurationGetOne = createAsyncThunk("ConfigurationGetOne", async () => {
    return await Configuration.method.get(`${Configuration.URL.get}${id}`).then((response) => response.data)
})

export const configurationPut = createAsyncThunk("ConfigurationPut", async (Data) => {
    return await Configuration.method.put(`${Configuration.URL.put}${id}`, Data).then((response) => response.data)
})
