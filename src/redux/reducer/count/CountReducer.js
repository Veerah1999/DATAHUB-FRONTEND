...
import { ChartTwoCount } from '../../../api/BackEndURL'
...
export const ChartTwo = createAsyncThunk("ChartCount", async () => {
    return await ChartTwoCount.method.get(ChartTwoCount.URL.get).then((response) => response.data)
})

export const ChartOne = createAsyncThunk("ChartOne", async () => {
    return await CountDetail.method.get(CountDetail.URL.get).then((response) => response.data)
})
export const Total = createAsyncThunk("Total", async () => {
    return await TotalCount.method.get(TotalCount.URL.get).then((response) => response.data)
})
