...
import { ConnectionDetail } from '../../../api/BackEndURL'
...
export const connectionDetailGet = createAsyncThunk("ConnectionDetailGet", async () => {
    return await ConnectionDetail.method.get(ConnectionDetail.URL.get).then((response) => response.data)
})
export const connectionDetailAdd = createAsyncThunk("ConnectionDetailAdd", async (Details) => {
    return await ConnectionDetail.method.post(`${ConnectionDetail.URL.post}`, Details).then((response) => response.data)
})
export const connectionDetailPutId = createAsyncThunk("connectionPutId", async (Detail) => {
    return await ConnectionDetail.method.put(`${ConnectionDetail.URL.put}${id}`, Detail).then((response) => response.data)
})
export const connectionDetailGetId = createAsyncThunk("ConnectionDetailGetID", async () => {
    return await ConnectionDetail.method.get(`${ConnectionDetail.URL.get}${id}`).then((response) => response.data)
})
