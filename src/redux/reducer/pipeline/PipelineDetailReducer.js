...
import {PipelineDetail} from '../../../api/BackEndURL'
...
export  const PipelinedetailPost=createAsyncThunk("PipelinedetailPost",async(Data)=>{
    return await PipelineDetail.method.post(PipelineDetail.URL.post,Data).then((response)=>response.data)
})
export  const PipelinedetailGetOne=createAsyncThunk("PipelinedetailGetOne",async()=>{
    return await PipelineDetail.method.get(`${PipelineDetail.URL.get}${id}`).then((response)=>response.data)
})
export const PipelinedetailPut= createAsyncThunk("PipelinedetailPut",async(Data)=>{
    return await PipelineDetail.method.put(`${PipelineDetail.URL.put}${id}`,Data).then((response)=>response.data)
})
