...
import { SchemaMigrateCreatePop, SchemaMigrateViewPop, SchemaMigrateEditPop, SchemaMigrateGet, SchemaMigrateOne, SchemaMigrateId } from '../../redux/reducer/configuration/SchemamigReducer';
...
import { SchemaAddForm } from '../../redux/reducer/configuration/SchemamigReducer'
import * as AI from 'react-icons/ai'
...
function Configuration(props) {
        ...
        return (
            {
                ...
                Source_Schema_name: val.source_schema_name,
    ...
    return (
        <Fragment>
            ...
            <Drawer title=" New Configuration" open={ConfigCreateOpen} maskClosable={false} onClose={ConfigurationCreateModal} ariaHideApp={false} width='75vh' footer={null}
                extra={
                    <Space >
            ...
            <Drawer title="Configuration Edit" open={ConfigEditOpen} maskClosable={false} onClose={ConfigurationEditModal} ariaHideApp={false} width='70vh' footer={null}
            // extra={
            //     <Space>
            //         <Button onClick={ConfigurationEditModal}>Cancel</Button>
            //     </Space>
            // }
            >
            ...
            <Drawer title=" Configuration View" open={ConfigViewOpen} maskClosable={false} onClose={ConfigurationViewModal} ariaHideApp={false} width='70vh' footer={null}
            // extra={
            //     <Space>
            ...
            {/* <Modal width='60vh'
                ...
                footer={[
                    <Button key="No" onClick={handlePauseCancel}>
                        No
                    </Button>,
                    <Button key="Yes" type="primary" onClick={handlePauseOk}>
                        Yes
                    </Button>]}
            >
                <div style={{ display: "flex", gap: ".3rem", fontFamily: "Nunito", fontWeight: 500, fontSize: "15px" }}>
            ...
            {/* <Modal title={false} style={{ top: 260 }} open={ConfigGetLoader} maskClosable={false} closable={false} ariaHideApp={false} width='20vh' footer={null}>
                <Loader />
            </Modal> */}
            <Drawer title=" New DataType " open={DtypecreateOpen} maskClosable={false} onClose={DtypeCreateModal} ariaHideApp={false} width='75vh' footer={null}
                extra={
            ...
            <Drawer title="Data Type View " open={DtypeViewOpen} maskClosable={false} onClose={DtypeViewModal} width='75vh' ariaHideApp={false} footer={null}
            // extra={
            //     <Space>
            ...
            <Drawer title="Edit Data Type " open={DtypeEditOpen} maskClosable={false} onClose={DtypeEditModal} width='75vh' ariaHideApp={false} footer={null}
            // extra={
            //     <Space>
            ...
            <Drawer title=" New Schema Migration " open={SchemaMigrationcreateOpen} maskClosable={false} onClose={SchemaMigrateCreateModal} ariaHideApp={false} width='75vh'  footer={null}
                extra={
            ...
            <Drawer title=" Schema Migration Edit " open={SchemaMigrationEditOpen} maskClosable={false} onClose={SchemaMigrateEditModal} width='75vh' ariaHideApp={false} footer={null}
            // extra={
            //     <Space>
            ...
            <Drawer title=" Schema Migration View " open={SchemaMigrationViewOpen} maskClosable={false} onClose={SchemaMigrateViewModal} width='75vh' ariaHideApp={false} footer={null}
            // extra={
            //     <Space>
            ...
            <Footer configData={configFilterData.length} DataType={dataTypeFilterData.length} schemamig={schemaMigrationFilterData.length} />
            </Fragment>
          )}
            </Fragment>
    )
