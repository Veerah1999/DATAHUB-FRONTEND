...
function Schedule(props) {
  ...
  return (
    <Fragment>
      ...
      <Drawer title="New Schedule Dependency" open={addModalOpen} maskClosable={false} onClose={addModalClose} ariaHideApp={false} width='75vh' footer={null}
      extra={
        <Space>
      ...
      <Drawer title="New Schedule"  open={listData} maskClosable={false} onClose={closeAddScheduleModal} ariaHideApp={false} width='85vh' footer={null}
      extra={
      ...
      <Drawer title="Edit Schedule" open={editschedModalOpen} maskClosable={false} onClose={closeEditScheduleModal} ariaHideApp={false} width='75vh' footer={null}
      // extra={
      //   <Space>
