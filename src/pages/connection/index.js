        ...
        <Fragment>
            {connectionLoader ? (
                ...
                if (value.view == true) {
                    ...
                    <Drawer title="New Connection" open={connectionAddModalOpen} maskClosable={false} onClose={connectionAddPopup} ariaHideApp={false} width='80vh' footer={null}
                        extra={
                            <Space>
                    ...
                    <Drawer title="Connection Edit" open={connectionEditModalOpen} maskClosable={false} onClose={connectionEditPopup} ariaHideApp={false} width='90vh' footer={null}

                    // extra={
                    //     <Space>
                    //         <Button onClick={connectionEditPopup}>Cancel</Button>
                    //     </Space>
                    // }
                    >
                        <ConnectionEdit />
                    </Drawer>
                    <Drawer title="Connection View" open={connectionViewModalOpen} maskClosable={false} onClose={connectionViewPopup} ariaHideApp={false} width='90vh' footer={null}
                    // extra={
                    //     <Space>
                    ...
                    <Drawer title="New Connection Detail" open={connectiondtlAddModalOpen} maskClosable={false} onClose={connectiondtlAddPopup} ariaHideApp={false} width='85vh' footer={null}
                        extra={
                            <Space>
                    ...
                    <Drawer title="Connection Detail Edit" open={connectiondtlEditModalOpen} maskClosable={false} onClose={connectiondtlEditPopup} ariaHideApp={false} width='85vh' footer={null}
                    // extra={
                    //     <Space>
                    ...
                    <Drawer title="Connection Detail View" open={connectiondtlViewModalOpen} maskClosable={false} onClose={connectiondtlViewPopup} ariaHideApp={false} width='85vh' footer={null}
                    // extra={
                    //     <Space>
