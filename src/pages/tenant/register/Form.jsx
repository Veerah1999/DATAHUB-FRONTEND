...
function FormOne() {
    ...
    useEffect(() => {
        ...
        if (form.formTwo !== false) {
            if (data.address.length !== 0 && data.country.length !== 0 && data.city.length !== 0 && data.postalcode.length !== 0 ) {
                if (/^(?=[^A-Z][A-Z])(?=[^a-z][a-z])(?=[^0-9]*[0-9]).{8,}$/.test(data.password)===true) {
    ...
    console.log(/^(?=[^A-Z][A-Z])(?=[^a-z][a-z])(?=[^0-9]*[0-9]).{6,}$/.test(data.password)===true)
    ...
    return (
        <Form name="basic" autoComplete="off" layout='vertical' size='large' style={{ fontFamily: "Nunito", height: "calc(100vh - 100px)", textTransform:'capitalize', width: "95%", margin: "10px auto 0 auto" }}>
            ...
            {form.formOne && <Row gutter={[16, 0]}>
                <Col xs={{ span: 5, offset: 1 }} lg={{ span: 11, offset: 1 }}>
                    ...
                    >
                        <Input name="company_name" style={{ borderRadius: "50px" }} onChange={handleChange} />
                    </Form.Item>
                </Col>
                ...
                <Col xs={{ span: 5, offset: 1 }} lg={{ span: 11, offset: 0 }}>
                    ...
                    >
                        <Input name="company_reg_no" style={{ borderRadius: "50px" }} onChange={handleChange} />
                    </Form.Item>
                </Col>
                ...
                <Col xs={{ span: 5, offset: 1 }} lg={{ span: 11, offset: 1 }}>
                    ...
                    >
                        <Input name="company_pan_no" style={{ borderRadius: "50px" }} onChange={handleChange} />
                    </Form.Item>
                </Col>
                ...
                <Col xs={{ span: 5, offset: 1 }} lg={{ span: 11, offset: 0 }}>
                    ...
                    >
                        <Input type="number" name="phone_number" style={{ borderRadius: "50px" }} onChange={handleChange} />
                    </Form.Item>
                </Col>
                ...
                <Col xs={{ span: 5, offset: 1 }} lg={{ span: 22, offset: 1 }}>
                    ...
                    >
                        <RangePicker disabledDate={disabledDate} defaultValue={[moment()]} onChange={datePickerOnChange} style={{ borderRadius: "50px", width: "100%" }} />
                    </Form.Item>
                </Col>
                ...
                <Col xs={{ span: 5, offset: 1 }} lg={{ span: 22, offset: 1 }}>
                    ...
                    >
                        <Input name="email" style={{ borderRadius: "50px" }} onChange={handleChange} />
                    </Form.Item>
                    {form.emailError && <p className='error'>Please Enter Valid E-mail</p>}
                </Col>

                <Col xs={{ span: 5, offset: 1 }} lg={{ span: 22, offset: 1 }}>
                    <Button onClick={next} type="primary" htmlType="submit" className='Tenant-Reg-Form-Next-Button' disabled={form.nextDisable} >Next</Button>
                </Col>
            </Row>}
            ...
            {form.formTwo && <Row gutter={[16, 0]}>
                <Col xs={{ span: 5, offset: 1 }} lg={{ span: 13, offset: 1 }}>
                    <Form.Item
                        ...
                        rules={[{ required: true, message: 'Please Enter Company Name', }]}
                    >
                        <Input name="address" style={{ borderRadius: "50px" }} onChange={handleChange} />
                    </Form.Item>
                </Col>
                ...
                <Col xs={{ span: 5, offset: 1 }} lg={{ span: 9, offset: 0 }}>
                    ...
                    >
                        <Input name="country" style={{ borderRadius: "50px" }} onChange={handleChange} />
                    </Form.Item>
                </Col>
                ...
                <Col xs={{ span: 5, offset: 1 }} lg={{ span: 11, offset: 1 }}>
                    ...
                    >
                        <Input name="city" style={{ borderRadius: "50px" }} onChange={handleChange} />
                    </Form.Item>
                </Col>
                ...
                <Col xs={{ span: 5, offset: 1 }} lg={{ span: 11, offset: 0 }}>
                    ...
                    >
                        <Input type="number" name="postalcode" style={{ borderRadius: "50px" }} onChange={handleChange} />
                    </Form.Item>
                </Col>
                ...
                <Col xs={{ span: 5, offset: 1 }} lg={{ span: 22, offset: 1 }}>
                    ...
                    >
                        <Input.Password name="password" style={{ borderRadius: "50px" }} onChange={handleChange} />
                    </Form.Item>
                    {/* {form.passwordPattern && <p className='error'> Password must be 8 Char , 1 Uppercase,Sp char & Numbers</p>} */}
                    <p style={{fontFamily:'Nunito',fontSize:'10px',fontWeight:'500',position:'relative',margin:'-10px 0 0 8px',color:'rgba(100,100,100,1)'}}> Password must be 8 Char , 1 Uppercase,Sp char & Numbers</p>
                </Col>
                ...
                <Col xs={{ span: 5, offset: 1 }} lg={{ span: 22, offset: 1 }}>
                    <Form.Item
                        ...
                        rules={[{ required: true, message: '', }]}
                    >
                        <Input.Password name="confirm_password" style={{ borderRadius: "50px" }} onChange={handleChange} />
                    </Form.Item>
                    {form.passwordchecker && <p className='error'>Confirm Password Doesn't Match</p>}
                </Col>

                <Col xs={{ span: 5, offset: 1 }} lg={{ span: 10, offset: 1 }}>
                    <Button onClick={back} className='Tenant-Reg-Form-Back-Button' >Back</Button>
                </Col>
                <Col xs={{ span: 5, offset: 1 }} lg={{ span: 10, offset: 2 }}>
                    <Button type="primary" htmlType="submit" className='Tenant-Reg-Form-Next-Button' disabled={form.registerDisable} onClick={codeGenerator}>Register</Button>
                </Col>
            </Row>}
